...
//06-06-2024
public class M_AddTwoNumbers_2 {
    public ListNode addTwoNumbers(ListNode list1, ListNode list2) {
        ...
        numberFromList1 += list1.val;
        numberFromList1 = new StringBuffer(numberFromList1).reverse().toString(); // это действие по условию задачи
        ...
        numberFromList2 += list2.val;
        numberFromList2 = new StringBuffer(numberFromList2).reverse().toString();
        ...
        sum = new StringBuffer(sum).reverse().toString(); // по условию задачи
